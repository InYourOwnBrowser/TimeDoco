                ...
                {importMode === 'replace' && showReplaceConfirm ? (
                  <div className="bg-red-50 dark:bg-red-900/20 p-4 rounded-md border border-red-200 dark:border-red-800/30 mb-4">
                    ...
                    <input
                      ...
                      placeholder="REPLACE"
                      className="w-full text-sm p-2 border border-red-300 dark:border-red-700 rounded bg-stone dark:bg-graphite text-graphite dark:text-stone mb-3 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-rust"
                    />
